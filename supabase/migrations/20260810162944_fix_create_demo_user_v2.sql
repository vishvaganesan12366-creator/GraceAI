/*
# Fix create_demo_user: gen_salt is in extensions schema

The pgcrypto extension functions gen_salt and crypt are in the "extensions" schema.
Updated the function to use extensions.gen_salt and extensions.crypt explicitly.
*/
